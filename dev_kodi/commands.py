...
commands = {
    ...
    'control': {
        'playpause':        {'read': False, 'write': True,  'opcode': 'Player.PlayPause',            'reply_token': 'Player.PlayPause',            'item_type': 'bool', 'dev_datatype': 'raw', 'params': ['playerid', 'play'], 'param_values': ['ID', 'toggle'], 'item_attrs': {'read_group_levels': 0}},
        ...
        'mute':             {'read': False, 'write': True,  'opcode': 'Application.SetMute',         'reply_token': 'Application.SetMute',         'item_type': 'bool', 'dev_datatype': 'raw', 'params': ['mute'], 'param_values': ['VAL'], 'item_attrs': {'read_group_levels': 0}},
        'volume':           {'read': False, 'write': True,  'opcode': 'Application.SetVolume',       'reply_token': 'Application.SetVolume',       'item_type': 'num',  'dev_datatype': 'raw', 'params': ['volume'], 'param_values': ['VAL'], 'cmd_settings': {'force_min': 0, 'force_max': 100}, 'item_attrs': {'read_group_levels': 0}},
