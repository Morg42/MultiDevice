...
commands = {
    ...
    'seek':             {'read': True, 'write': True,  'opcode': 'Player.Seek',                 'reply_token': 'Player.Seek',                 'item_type': 'num',  'dev_datatype': 'raw', 'params': ['playerid', 'value'], 'param_values': ['ID', 'VAL'], 'settings': {'force_min': 0.0, 'force_max': 100.0}},
    ...
    'speed':            {'read': True, 'write': True,  'opcode': 'Player.SetSpeed',             'reply_token': 'Player.SetSpeed',             'item_type': 'int',  'dev_datatype': 'raw', 'params': ['playerid', 'speed'], 'param_values': ['ID', 'VAL'], 'settings': {'valid_list': [-32,-16,-8,-4,-2,-1,1,2,4,8,16,32]}},
    ...
    'goto':             {'read': True, 'write': True,  'opcode': 'Player.GoTo',                 'reply_token': 'Player.GoTo',                 'item_type': 'str',  'dev_datatype': 'raw', 'params': ['playerid', 'to'], 'param_values': ['ID', 'VAL'], 'settings': {'valid_list': ['previous','next']}},
    ...
    'volume':           {'read': True, 'write': True,  'opcode': 'Application.SetVolume',       'reply_token': 'Application.SetVolume',       'item_type': 'int',  'dev_datatype': 'raw', 'params': ['volume'], 'param_values': ['VAL'], 'settings': {'force_min': 0, 'force_max': 100}},
