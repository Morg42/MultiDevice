...
commands = {
    ...
    'control': {
        ...
        'speed':            {'read': True, 'write': True,  'opcode': 'Player.SetSpeed',             'reply_token': 'Player.SetSpeed',             'item_type': 'num',  'dev_datatype': 'raw', 'params': ['playerid', 'speed'], 'param_values': ['ID', 'VAL'], 'cmd_settings': {'valid_list': [-32,-16,-8,-4,-2,-1,1,2,4,8,16,32]}},
        ...
        'volume':           {'read': True, 'write': True,  'opcode': 'Application.SetVolume',       'reply_token': 'Application.SetVolume',       'item_type': 'num',  'dev_datatype': 'raw', 'params': ['volume'], 'param_values': ['VAL'], 'cmd_settings': {'force_min': 0, 'force_max': 100}},
