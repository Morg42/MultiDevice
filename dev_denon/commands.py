...
commands = {
    ...
    'general/sourcename_DVD': { 'read': True, 'write': False, 'read_cmd': 'SSFUN ?', 'item_type': 'str', 'dev_datatype': 'str', 'reply_token': 'REGEX', 'reply_pattern': 'SSFUNDVD (.*)' },
    'general/sourcename_BD': { 'read': True, 'write': False, 'read_cmd': 'SSFUN ?', 'item_type': 'str', 'dev_datatype': 'str', 'reply_token': 'REGEX', 'reply_pattern': 'SSFUNBD (.*)' },
    'general/sourcename_TV': { 'read': True, 'write': False, 'read_cmd': 'SSFUN ?', 'item_type': 'str', 'dev_datatype': 'str', 'reply_token': 'REGEX', 'reply_pattern': 'SSFUNTV (.*)' },
    'general/sourcename_SAT': { 'read': True, 'write': False, 'read_cmd': 'SSFUN ?', 'item_type': 'str', 'dev_datatype': 'str', 'reply_token': 'REGEX', 'reply_pattern': 'SSFUNSAT/CBL (.*)' },
    'general/sourcename_MPLAY': { 'read': True, 'write': False, 'read_cmd': 'SSFUN ?', 'item_type': 'str', 'dev_datatype': 'str', 'reply_token': 'REGEX', 'reply_pattern': 'SSFUNMPLAY (.*)' },
    'general/sourcename_GAME': { 'read': True, 'write': False, 'read_cmd': 'SSFUN ?', 'item_type': 'str', 'dev_datatype': 'str', 'reply_token': 'REGEX', 'reply_pattern': 'SSFUNGAME (.*)' },
    'general/sourcename_AUX1': { 'read': True, 'write': False, 'read_cmd': 'SSFUN ?', 'item_type': 'str', 'dev_datatype': 'str', 'reply_token': 'REGEX', 'reply_pattern': 'SSFUNAUX1 (.*)' },
    'general/sourcename_CD': { 'read': True, 'write': False, 'read_cmd': 'SSFUN ?', 'item_type': 'str', 'dev_datatype': 'str', 'reply_token': 'REGEX', 'reply_pattern': 'SSFUNCD (.*)' },
    'general/sourcename_AUX2': { 'read': True, 'write': False, 'read_cmd': 'SSFUN ?', 'item_type': 'str', 'dev_datatype': 'str', 'reply_token': 'REGEX', 'reply_pattern': 'SSFUNAUX2 (.*)' },
    'general/sourcename_PHONO': { 'read': True, 'write': False, 'read_cmd': 'SSFUN ?', 'item_type': 'str', 'dev_datatype': 'str', 'reply_token': 'REGEX', 'reply_pattern': 'SSFUNPHONO (.*)' },
    ...
    'zone1/source': { 'read': True, 'write': True, 'read_cmd': 'SI?', 'write_cmd': 'SIMD_VALUE', 'item_type': 'str', 'dev_datatype': 'str', 'reply_token': 'REGEX', 'reply_pattern': 'SI(.*)', 'lookup': 'SOURCE' },
    'zone1/listeningmode': { 'read': True, 'write': True, 'settings': {'valid_list_ci': ['MOVIE', 'MUSIC', 'GAME', 'DIRECT', 'PURE DIRECT', 'STEREO', 'AUTO', 'DOLBY DIGITAL', 'DTS SURROUND', 'AURO3D', 'AURO2DSURR', 'MCH STEREO', 'WIDE SCREEN', 'SUPER STADIUM', 'ROCK ARENA', 'JAZZ CLUB', 'CLASSIC CONCERT', 'MONO MOVIE', 'MATRIX', 'VIDEO GAME', 'VIRTUAL', 'LEFT', 'RIGHT']}, 'read_cmd': 'MS?', 'write_cmd': ':MS{VAL_UPPER}:', 'item_type': 'str', 'dev_datatype': 'str', 'reply_token': 'REGEX', 'reply_pattern': 'MS(.*)' },
    ...
    'zone1/speakersetup': { 'opcode': 'MD_VALUE', 'read': True, 'write': True, 'settings': {'valid_list_ci': ['FL', 'HF', 'FR']}, 'read_cmd': 'PSSP: ?', 'write_cmd': ':PSSP:{VAL_UPPER}:', 'item_type': 'str', 'dev_datatype': 'str', 'reply_token': 'REGEX', 'reply_pattern': 'PSSP:(FL|HF|FR)' },
    ...
    'zone1/audioinput': { 'read': True, 'write': True, 'settings': {'valid_list_ci': ['AUTO', 'HDMI', 'DIGITAL', 'ANALOG', '7.1IN', 'NO']}, 'read_cmd': 'SD?', 'write_cmd': ':SD{VAL_UPPER}:', 'item_type': 'str', 'dev_datatype': 'str', 'reply_token': 'REGEX', 'reply_pattern': 'SD(.*)' },
    'zone1/digitalinput': { 'read': True, 'write': True, 'settings': {'valid_list_ci': ['AUTO', 'PCM', 'DTS']}, 'read_cmd': 'DC?', 'write_cmd': ':DC{VAL_UPPER}:', 'item_type': 'str', 'dev_datatype': 'str', 'reply_token': 'REGEX', 'reply_pattern': 'DC(.*)' },
    'zone1/videoinput': { 'read': True, 'write': True, 'settings': {'valid_list_ci': ['DVD', 'BD', 'TV', 'SAT/CBL', 'MPLAY', 'GAME' 'AUX1', 'AUX2', 'AUX3', 'AUX4', 'AUX5', 'AUX6', 'AUX7', 'CD', 'ON', 'OFF']}, 'read_cmd': 'SV?', 'write_cmd': ':SV{VAL_UPPER}:', 'item_type': 'str', 'dev_datatype': 'str', 'reply_token': 'REGEX', 'reply_pattern': 'SV(.*)' },
    ...
    'zone2/source': { 'read': True, 'write': True, 'read_cmd': 'Z2?', 'write_cmd': 'Z2MD_VALUE', 'item_type': 'str', 'dev_datatype': 'str', 'reply_token': 'REGEX', 'reply_pattern': 'Z2(.*)', 'lookup': 'SOURCE' },
    ...
    'zone3/source': { 'read': True, 'write': True, 'read_cmd': 'Z3?', 'write_cmd': ':Z3{VAL_UPPER}:', 'item_type': 'str', 'dev_datatype': 'str', 'reply_token': 'REGEX', 'reply_pattern': 'Z3(.*)', 'lookup': 'SOURCE' },
