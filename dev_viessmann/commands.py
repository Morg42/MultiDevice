...
commands = {
    'ALL': {
        'Anlagentyp': {'read': True, 'write': False, 'opcode': '00f8', 'reply_token': '00f8', 'item_type': 'num', 'dev_datatype': 'V', 'params': ['value', 'len'], 'param_values': ['VAL', 2], 'lookup': 'devicetypes', 'item_attrs': {'no_read_groups': True, 'attributes': {'md_read_initial': True}}},     # getAnlTyp -- Information - Allgemein: Anlagentyp (204D)
    },
    'V200KO1B': {
        'Allgemein': {
            'Temperatur': {
            ...
            'TempKOffset':              {'read': True, 'write': True,  'opcode': '6760', 'reply_token': '6760', 'item_type': 'num',  'dev_datatype': 'V', 'params': ['value', 'signed', 'len'], 'param_values': ['VAL', True, 1], 'cmd_settings': {'force_min': 0, 'force_max': 1193045}},     # Kesseloffset KT ueber WWsoll in Grad C
            ...
            'CtrlId':                   {'read': True, 'write': False, 'opcode': '08e0', 'reply_token': '08e0', 'item_type': 'num',  'dev_datatype': 'V', 'params': ['value', 'len'], 'param_values': ['VAL', 7], 'lookup': 'devicetypes'},     # Reglerkennung
        },
        'Kessel': {
            # Kessel
        ...
        'Fehler': {
            ...
            'Error2':                   {'read': True, 'write': False, 'opcode': '7519', 'reply_token': '7519', 'item_type': 'num',  'dev_datatype': 'V', 'params': ['value', 'len'], 'param_values': ['VAL', 9], 'lookup': 'errors'},     # Fehlerhistory Eintrag 3
            'Error3':                   {'read': True, 'write': False, 'opcode': '7522', 'reply_token': '7522', 'item_type': 'num',  'dev_datatype': 'V', 'params': ['value', 'len'], 'param_values': ['VAL', 9], 'lookup': 'errors'},     # Fehlerhistory Eintrag 4
            'Error4':                   {'read': True, 'write': False, 'opcode': '752b', 'reply_token': '752b', 'item_type': 'num',  'dev_datatype': 'V', 'params': ['value', 'len'], 'param_values': ['VAL', 9], 'lookup': 'errors'},     # Fehlerhistory Eintrag 5
            'Error5':                   {'read': True, 'write': False, 'opcode': '7534', 'reply_token': '7534', 'item_type': 'num',  'dev_datatype': 'V', 'params': ['value', 'len'], 'param_values': ['VAL', 9], 'lookup': 'errors'},     # Fehlerhistory Eintrag 6
            'Error6':                   {'read': True, 'write': False, 'opcode': '753d', 'reply_token': '753d', 'item_type': 'num',  'dev_datatype': 'V', 'params': ['value', 'len'], 'param_values': ['VAL', 9], 'lookup': 'errors'},     # Fehlerhistory Eintrag 7
            'Error7':                   {'read': True, 'write': False, 'opcode': '7546', 'reply_token': '7546', 'item_type': 'num',  'dev_datatype': 'V', 'params': ['value', 'len'], 'param_values': ['VAL', 9], 'lookup': 'errors'},     # Fehlerhistory Eintrag 8
            'Error8':                   {'read': True, 'write': False, 'opcode': '754f', 'reply_token': '754f', 'item_type': 'num',  'dev_datatype': 'V', 'params': ['value', 'len'], 'param_values': ['VAL', 9], 'lookup': 'errors'},     # Fehlerhistory Eintrag 9
        ...
        'Brenner': {
            ...
            'Oeldurchsatz':             {'read': True, 'write': True,  'opcode': '5726', 'reply_token': '5726', 'item_type': 'num',  'dev_datatype': 'V', 'params': ['value', 'signed', 'len'], 'param_values': ['VAL', True, 4], 'cmd_settings': {'force_min': 0, 'force_max': 1193045}},     # Oeldurchsatz Brenner in Dezi-Liter pro Stunde
            ...
            'A1M1': {
                ...
                'Temperatur': {           
                    'Raum': {
                        ...
                        'Soll_Red_Betrieb':              {'read': True, 'write': True,  'opcode': '2307', 'reply_token': '2307', 'item_type': 'num', 'dev_datatype': 'V', 'params': ['value', 'signed', 'len'], 'param_values': ['VAL', True, 1], 'cmd_settings': {'force_min': 3, 'force_max': 37}},     # Raumtemperatur Soll Reduzierter Betrieb A1M1
                        'Soll_Party_Betrieb':            {'read': True, 'write': True,  'opcode': '2308', 'reply_token': '2308', 'item_type': 'num', 'dev_datatype': 'V', 'params': ['value', 'signed', 'len'], 'param_values': ['VAL', True, 1], 'cmd_settings': {'force_min': 3, 'force_max': 37}},     # Raumtemperatur Soll Party Betrieb A1M1
                    },
                    'Vorlauf': {
                        ...
                        'Min':                           {'read': True, 'write': True,  'opcode': '27c5', 'reply_token': '27c5', 'item_type': 'num', 'dev_datatype': 'V', 'params': ['value', 'signed', 'len'], 'param_values': ['VAL', True, 1], 'cmd_settings': {'force_min': 1, 'force_max': 127}},     # Minimalbegrenzung der Vorlauftemperatur
                        'Max':                           {'read': True, 'write': True,  'opcode': '27c6', 'reply_token': '27c6', 'item_type': 'num', 'dev_datatype': 'V', 'params': ['value', 'signed', 'len'], 'param_values': ['VAL', True, 1], 'cmd_settings': {'force_min': 10, 'force_max': 127}},     # Maximalbegrenzung der Vorlauftemperatur
                        'Erhoehung_Soll':                {'read': True, 'write': True,  'opcode': '27fa', 'reply_token': '27fa', 'item_type': 'num', 'dev_datatype': 'V', 'params': ['value', 'signed', 'len'], 'param_values': ['VAL', True, 1], 'cmd_settings': {'force_min': 0, 'force_max': 50}},     # Erhöhung des Kesselwasser- bzw. Vorlauftemperatur-Sollwertes beim Übergang von Betrieb mit reduzierter Raumtemperatur in den Betrieb mit normaler Raumtemperatur um 20 %
                        'Erhoehung_Zeit':                {'read': True, 'write': True,  'opcode': '27fa', 'reply_token': '27fa', 'item_type': 'num', 'dev_datatype': 'V', 'params': ['value', 'signed', 'len'], 'param_values': ['VAL', True, 1], 'cmd_settings': {'force_min': 0, 'force_max': 150}},     # Zeitdauer für die Erhöhung des Kesselwasser bzw.VorlauftemperaturSollwertes (siehe Codieradresse „FA“) 60 min.
                    },
                ...
                'Status': {           
                    ...
                    'Speichervorrang':                   {'read': True, 'write': True,  'opcode': '27a2', 'reply_token': '27a2', 'item_type': 'num', 'dev_datatype': 'V', 'params': ['value', 'len'], 'param_values': ['VAL', 1], 'cmd_settings': {'force_min': 0, 'force_max': 15}},     # Speichervorrang auf Heizkreispumpe und Mischer
                    'Frostschutzgrenze':                 {'read': True, 'write': True,  'opcode': '27a3', 'reply_token': '27a3', 'item_type': 'num', 'dev_datatype': 'V', 'params': ['value', 'signed', 'len'], 'param_values': ['VAL', True, 1], 'cmd_settings': {'force_min': -9, 'force_max': 15}},     # Frostschutzgrenze
                    'Frostschutz':                       {'read': True, 'write': True,  'opcode': '27a4', 'reply_token': '27a4', 'item_type': 'num', 'dev_datatype': 'V', 'params': ['value', 'len'], 'param_values': ['VAL', 1], 'cmd_settings': {'force_min': 0, 'force_max': 1}},     # Frostschutzgrenze
                    'Heizkreispumpenlogik':              {'read': True, 'write': True,  'opcode': '27a5', 'reply_token': '27a5', 'item_type': 'num', 'dev_datatype': 'V', 'params': ['value', 'signed', 'len'], 'param_values': ['VAL', True, 1], 'cmd_settings': {'force_min': 0, 'force_max': 15}},     # HeizkreispumpenlogikFunktion
                    'Sparschaltung':                     {'read': True, 'write': True,  'opcode': '27a6', 'reply_token': '27a6', 'item_type': 'num', 'dev_datatype': 'V', 'params': ['value', 'signed', 'len'], 'param_values': ['VAL', True, 1], 'cmd_settings': {'force_min': 5, 'force_max': 35}},     # AbsolutSommersparschaltung
                ...
                'Partybetrieb_Zeitbegrenzung':           {'read': True, 'write': True,  'opcode': '27f2', 'reply_token': '27f2', 'item_type': 'num', 'dev_datatype': 'V', 'params': ['value', 'len'], 'param_values': ['VAL', 1], 'cmd_settings': {'force_min': 0, 'force_max': 12}},     # Zeitliche Begrenzung für Partybetrieb oder externe BetriebsprogrammUmschaltung mit Taster
            },
            'M2': {
                # Heizkreis M2
                'Temperatur': {           
                    'Raum': {
                        ...
                        'Soll_Red_Betrieb':              {'read': True, 'write': True,  'opcode': '3307', 'reply_token': '3307', 'item_type': 'num', 'dev_datatype': 'V', 'params': ['value', 'signed', 'len'], 'param_values': ['VAL', True, 1], 'cmd_settings': {'force_min': 3, 'force_max': 37}},     # Raumtemperatur Soll Reduzierter Betrieb
                        'Soll_Party_Betrieb':            {'read': True, 'write': True,  'opcode': '3308', 'reply_token': '3308', 'item_type': 'num', 'dev_datatype': 'V', 'params': ['value', 'signed', 'len'], 'param_values': ['VAL', True, 1], 'cmd_settings': {'force_min': 3, 'force_max': 37}},     # Raumtemperatur Soll Party Betrieb
                    },
                    'Vorlauf': {
                        ...
                        'Min':                           {'read': True, 'write': True,  'opcode': '37c5', 'reply_token': '37c5', 'item_type': 'num', 'dev_datatype': 'V', 'params': ['value', 'signed', 'len'], 'param_values': ['VAL', True, 1], 'cmd_settings': {'force_min': 1, 'force_max': 127}},     # Minimalbegrenzung der Vorlauftemperatur
                ...
                'Status': {           
                    ...
                    'Speichervorrang':                   {'read': True, 'write': True,  'opcode': '37a2', 'reply_token': '37a2', 'item_type': 'num', 'dev_datatype': 'V', 'params': ['value', 'len'], 'param_values': ['VAL', 1], 'cmd_settings': {'force_min': 0, 'force_max': 15}},     # Speichervorrang auf Heizkreispumpe und Mischer
                    'Frostschutzgrenze':                 {'read': True, 'write': True,  'opcode': '37a3', 'reply_token': '37a3', 'item_type': 'num', 'dev_datatype': 'V', 'params': ['value', 'signed', 'len'], 'param_values': ['VAL', True, 1], 'cmd_settings': {'force_min': -9, 'force_max': 15}},     # Frostschutzgrenze
                    'Frostschutz':                       {'read': True, 'write': True,  'opcode': '37a4', 'reply_token': '37a4', 'item_type': 'num', 'dev_datatype': 'V', 'params': ['value', 'len'], 'param_values': ['VAL', 1], 'cmd_settings': {'force_min': 0, 'force_max': 1}},     # Frostschutzgrenze
                    'Heizkreispumpenlogik':              {'read': True, 'write': True,  'opcode': '37a5', 'reply_token': '37a5', 'item_type': 'num', 'dev_datatype': 'V', 'params': ['value', 'signed', 'len'], 'param_values': ['VAL', True, 1], 'cmd_settings': {'force_min': 0, 'force_max': 15}},     # HeizkreispumpenlogikFunktion
                    'Sparschaltung':                     {'read': True, 'write': True,  'opcode': '37a6', 'reply_token': '37a6', 'item_type': 'num', 'dev_datatype': 'V', 'params': ['value', 'signed', 'len'], 'param_values': ['VAL', True, 1], 'cmd_settings': {'force_min': 5, 'force_max': 35}},     # AbsolutSommersparschaltung
                ...
                'Partybetrieb_Zeitbegrenzung':           {'read': True, 'write': True,  'opcode': '37f2', 'reply_token': '37f2', 'item_type': 'num', 'dev_datatype': 'V', 'params': ['value', 'len'], 'param_values': ['VAL', 1], 'cmd_settings': {'force_min': 0, 'force_max': 12}},     # Zeitliche Begrenzung für Partybetrieb oder externe BetriebsprogrammUmschaltung mit Taster
            },
        },
        'Warmwasser': {
            # Warmwasser
            ...
            'Soll':             {'read': True, 'write': True,  'opcode': '6300', 'reply_token': '6300', 'item_type': 'num',  'dev_datatype': 'V', 'params': ['value', 'signed', 'len'], 'param_values': ['VAL', True, 1], 'cmd_settings': {'force_min': 10, 'force_max': 95}},     # Warmwasser-Solltemperatur
            ...
            'PumpenNachlauf':   {'read': True, 'write': True,  'opcode': '6762', 'reply_token': '6762', 'item_type': 'num',  'dev_datatype': 'V', 'params': ['value', 'signed', 'len'], 'param_values': ['VAL', True, 2], 'cmd_settings': {'force_min': 0, 'force_max': 1}},     # Warmwasserpumpennachlauf
        },
        'Ferienprogramm': {
            'A1M1': {
                # Ferienprogramm HK
                'Status':       {'read': True, 'write': False, 'opcode': '2535', 'reply_token': '2535', 'item_type': 'num',  'dev_datatype': 'V', 'params': ['value', 'len'], 'param_values': ['VAL', 1]},     # Ferienprogramm A1M1
    ...
    'V200HO1C': {
        'Allgemein': {
            # Allgemein
            'Anlagenschema':        {'read': True, 'write': False, 'opcode': '7700', 'reply_token': '7700', 'item_type': 'num',  'dev_datatype': 'V', 'params': ['value', 'len'], 'param_values': ['VAL', 2], 'lookup': 'systemschemes'},     # Anlagenschema
            'Frostgefahr':          {'read': True, 'write': False, 'opcode': '2510', 'reply_token': '2510', 'item_type': 'num',  'dev_datatype': 'V', 'params': ['value', 'len'], 'param_values': ['VAL', 1]},     # Frostgefahr
        ...
        'Brenner': {
            # Brenner
            'Starts':               {'read': True, 'write': False, 'opcode': '088a', 'reply_token': '088a', 'item_type': 'num',  'dev_datatype': 'V', 'params': ['value', 'signed', 'len'], 'param_values': ['VAL', True, 4]},     # Brennerstarts
        ...
        'Solar': {
            ...
            'Waermemenge':          {'read': True, 'write': False, 'opcode': '6560', 'reply_token': '6560', 'item_type': 'num',  'dev_datatype': 'V', 'params': ['value', 'len'], 'param_values': ['VAL', 2]},     # Solar Waermemenge
            'Ausbeute':             {'read': True, 'write': False, 'opcode': 'cf30', 'reply_token': 'cf30', 'item_type': 'num',  'dev_datatype': 'V', 'params': ['value', 'len'], 'param_values': ['VAL', 4]},     # Solar Ausbeute
        },
        'Heizkreis': {
            '1': {
                # Heizkreis 1            
    ...
    'V200KW2': {
            ...
            'A1M1': {
                ...
                'Temperatur': {           
                    'Raum': {
                        ...
                        'Soll_Party':     {'read': True, 'write': True,  'opcode': '2308', 'reply_token': '2308', 'item_type': 'num',  'dev_datatype': 'V', 'params': ['value', 'signed', 'len'], 'param_values': ['VAL', True, 1], 'cmd_settings': {'force_min': 4, 'force_max': 37}},     # Raumtemperatur Soll Party Betrieb A1M1
                    },
                    'Vorlauf': {
                        'Ist':            {'read': True, 'write': False, 'opcode': '2900', 'reply_token': '2900', 'item_type': 'num',  'dev_datatype': 'V', 'params': ['value', 'mult', 'len'], 'param_values': ['VAL', 10, 2]},     # Vorlauftemperatur A1M1
                        'Soll':           {'read': True, 'write': False, 'opcode': '2544', 'reply_token': '2544', 'item_type': 'num',  'dev_datatype': 'V', 'params': ['value', 'mult', 'len'], 'param_values': ['VAL', 10, 2]},     # Vorlauftemperatur Soll A1M1
                ...
                'Betriebsart':            {'read': True, 'write': True,  'opcode': '2301', 'reply_token': '2301', 'item_type': 'num',  'dev_datatype': 'V', 'params': ['value', 'len'], 'param_values': ['VAL', 1], 'lookup': 'operatingmodes'},     # Betriebsart A1M1
                'Aktuelle_Betriebsart':   {'read': True, 'write': False, 'opcode': '2500', 'reply_token': '2500', 'item_type': 'num',  'dev_datatype': 'V', 'params': ['value', 'len'], 'param_values': ['VAL', 1], 'lookup': 'operatingmodes'},     # Aktuelle Betriebsart A1M1
                'Sparbetrieb':            {'read': True, 'write': True,  'opcode': '2302', 'reply_token': '2302', 'item_type': 'num',  'dev_datatype': 'V', 'params': ['value', 'len'], 'param_values': ['VAL', 1], 'cmd_settings': {'force_min': 0, 'force_max': 1}},     # Sparbetrieb A1M1
                'Partybetrieb_Zeit':      {'read': True, 'write': True,  'opcode': '27f2', 'reply_token': '27f2', 'item_type': 'num',  'dev_datatype': 'V', 'params': ['value', 'len'], 'param_values': ['VAL', 1], 'cmd_settings': {'force_min': 0, 'force_max': 12}},     # Partyzeit M2
                'Partybetrieb':           {'read': True, 'write': True,  'opcode': '2303', 'reply_token': '2303', 'item_type': 'num',  'dev_datatype': 'V', 'params': ['value', 'len'], 'param_values': ['VAL', 1], 'cmd_settings': {'force_min': 0, 'force_max': 1}},     # Partybetrieb A1M1
            ...
            'M2': {
                ...
                'Temperatur': {           
                    'Raum': {
                        ...
                        'Soll_Party':     {'read': True, 'write': True,  'opcode': '3308', 'reply_token': '3308', 'item_type': 'num',  'dev_datatype': 'V', 'params': ['value', 'signed', 'len'], 'param_values': ['VAL', True, 1], 'cmd_settings': {'force_min': 4, 'force_max': 37}},     # Raumtemperatur Soll Party Betrieb
                    },
                    'Vorlauf': {
                        ...
                        'Min':            {'read': True, 'write': True,  'opcode': '37c5', 'reply_token': '37c5', 'item_type': 'num',  'dev_datatype': 'V', 'params': ['value', 'signed', 'len'], 'param_values': ['VAL', True, 1], 'cmd_settings': {'force_min': 1, 'force_max': 127}},     # Minimalbegrenzung der Vorlauftemperatur
                        'Max':            {'read': True, 'write': True,  'opcode': '37c6', 'reply_token': '37c6', 'item_type': 'num',  'dev_datatype': 'V', 'params': ['value', 'signed', 'len'], 'param_values': ['VAL', True, 1], 'cmd_settings': {'force_min': 1, 'force_max': 127}},     # Maximalbegrenzung der Vorlauftemperatur
                    },
                },
                'Betriebsart':            {'read': True, 'write': True,  'opcode': '3301', 'reply_token': '3301', 'item_type': 'num',  'dev_datatype': 'V', 'params': ['value', 'len'], 'param_values': ['VAL', 1], 'lookup': 'operatingmodes'},     # Betriebsart M2
                'Aktuelle_Betriebsart':   {'read': True, 'write': False, 'opcode': '3500', 'reply_token': '3500', 'item_type': 'num',  'dev_datatype': 'V', 'params': ['value', 'len'], 'param_values': ['VAL', 1], 'lookup': 'operatingmodes'},     # Aktuelle Betriebsart M2
                'Sparbetrieb':            {'read': True, 'write': True,  'opcode': '3302', 'reply_token': '3302', 'item_type': 'num',  'dev_datatype': 'V', 'params': ['value', 'len'], 'param_values': ['VAL', 1], 'cmd_settings': {'force_min': 0, 'force_max': 1}},     # Sparbetrieb
                'Partybetrieb':           {'read': True, 'write': True,  'opcode': '3303', 'reply_token': '3303', 'item_type': 'num',  'dev_datatype': 'V', 'params': ['value', 'len'], 'param_values': ['VAL', 1], 'cmd_settings': {'force_min': 0, 'force_max': 1}},     # Partybetrieb A1M1
                'Partybetrieb_Zeit':      {'read': True, 'write': True,  'opcode': '37f2', 'reply_token': '37f2', 'item_type': 'num',  'dev_datatype': 'V', 'params': ['value', 'len'], 'param_values': ['VAL', 1], 'cmd_settings': {'force_min': 0, 'force_max': 12}},     # Partyzeit M2
                ...
                'Heizkreispumpenlogik':   {'read': True, 'write': True,  'opcode': '37a5', 'reply_token': '37a5', 'item_type': 'num',  'dev_datatype': 'V', 'params': ['value', 'signed', 'len'], 'param_values': ['VAL', True, 1], 'cmd_settings': {'force_min': 0, 'force_max': 15}},     # 0=ohne HPL-Funktion, 1=AT > RTsoll + 5 K, 2=AT > RTsoll + 4 K, 3=AT > RTsoll + 3 K, 4=AT > RTsoll + 2 K, 5=AT > RTsoll + 1 K, 6=AT > RTsoll, 7=AT > RTsoll - 1 K, 8=AT > RTsoll - 2 K, 9=AT > RTsoll - 3 K, 10=AT > RTsoll - 4 K, 11=AT > RTsoll - 5 K, 12=AT > RTsoll - 6 K, 13=AT > RTsoll - 7 K, 14=AT > RTsoll - 8 K, 15=AT > RTsoll - 9 K
        ...
        'Warmwasser': {
            ...
            'SollMax':          {'read': True, 'write': False, 'opcode': '675a', 'reply_token': '675a', 'item_type': 'num',  'dev_datatype': 'V', 'params': ['value', 'len'], 'param_values': ['VAL', 1]},     # 0=inaktiv, 1=aktiv
        },
        'Ferienprogramm': {
            'A1M1': {
                # Ferienprogramm HK            
    ...
    'V200WO1C': {
        'Allgemein': {'item_attrs': {'cycle': 45},
            ...
            'Status_Fanspeed':        {'read': True, 'write': False, 'opcode': '1a53', 'reply_token': '1a53', 'item_type': 'num',  'dev_datatype': 'V', 'params': ['value', 'len'], 'param_values': ['VAL', 1]},     # getSpdFan -- Geschwindigkeit Luefter
            'Kompressor_Freq':        {'read': True, 'write': False, 'opcode': '1a54', 'reply_token': '1a54', 'item_type': 'num',  'dev_datatype': 'V', 'params': ['value', 'len'], 'param_values': ['VAL', 1]},     # getSpdKomp -- Compressor Frequency
            'SollLeistungVerdichter': {'read': True, 'write': False, 'opcode': '5030', 'reply_token': '5030', 'item_type': 'num',  'dev_datatype': 'V', 'params': ['value', 'len'], 'param_values': ['VAL', 1]},     # getPwrSollVerdichter -- Diagnose - Anlagenuebersicht: Soll-Leistung Verdichter 1 (0..100)
        },
        'Pumpen': {
        ...
        'Statistik': {
            ...
            'Einschaltungen': {
                'Sekundaer':          {'read': True, 'write': False, 'opcode': '0504', 'reply_token': '0504', 'item_type': 'num',  'dev_datatype': 'V', 'params': ['value', 'len'], 'param_values': ['VAL', 4]},     # getAnzQuelleSek -- Statistik - Schaltzyklen Anlage: Einschaltungen Sekundaerquelle (?)
                'Heizstab1':          {'read': True, 'write': False, 'opcode': '0508', 'reply_token': '0508', 'item_type': 'num',  'dev_datatype': 'V', 'params': ['value', 'len'], 'param_values': ['VAL', 4]},     # getAnzHeizstabSt1 -- Statistik - Schaltzyklen Anlage: Einschaltungen Heizstab Stufe 1 (?)
                'Heizstab2':          {'read': True, 'write': False, 'opcode': '0509', 'reply_token': '0509', 'item_type': 'num',  'dev_datatype': 'V', 'params': ['value', 'len'], 'param_values': ['VAL', 4]},     # getAnzHeizstabSt2 -- Statistik - Schaltzyklen Anlage: Einschaltungen Heizstab Stufe 2 (?)
                'HK':                 {'read': True, 'write': False, 'opcode': '050d', 'reply_token': '050d', 'item_type': 'num',  'dev_datatype': 'V', 'params': ['value', 'len'], 'param_values': ['VAL', 4]},     # getAnzHK -- Statistik - Schaltzyklen Anlage: Einschaltungen Heizkreis (?)
            },
            'Laufzeiten': {
                ...
                'VerdichterStufe1':   {'read': True, 'write': False, 'opcode': '1620', 'reply_token': '1620', 'item_type': 'num',  'dev_datatype': 'V', 'params': ['value', 'len'], 'param_values': ['VAL', 4]},     # getLZVerdSt1 -- Statistik - Betriebsstunden Anlage: Betriebsstunden Verdichter auf Stufe 1 (?)
                'VerdichterStufe2':   {'read': True, 'write': False, 'opcode': '1622', 'reply_token': '1622', 'item_type': 'num',  'dev_datatype': 'V', 'params': ['value', 'len'], 'param_values': ['VAL', 4]},     # getLZVerdSt2 -- Statistik - Betriebsstunden Anlage: Betriebsstunden Verdichter auf Stufe 2 (?)
                'VerdichterStufe3':   {'read': True, 'write': False, 'opcode': '1624', 'reply_token': '1624', 'item_type': 'num',  'dev_datatype': 'V', 'params': ['value', 'len'], 'param_values': ['VAL', 4]},     # getLZVerdSt3 -- Statistik - Betriebsstunden Anlage: Betriebsstunden Verdichter auf Stufe 3 (?)
                'VerdichterStufe4':   {'read': True, 'write': False, 'opcode': '1626', 'reply_token': '1626', 'item_type': 'num',  'dev_datatype': 'V', 'params': ['value', 'len'], 'param_values': ['VAL', 4]},     # getLZVerdSt4 -- Statistik - Betriebsstunden Anlage: Betriebsstunden Verdichter auf Stufe 4 (?)
                'VerdichterStufe5':   {'read': True, 'write': False, 'opcode': '1628', 'reply_token': '1628', 'item_type': 'num',  'dev_datatype': 'V', 'params': ['value', 'len'], 'param_values': ['VAL', 4]},     # getLZVerdSt5 -- Statistik - Betriebsstunden Anlage: Betriebsstunden Verdichter auf Stufe 5 (?)
            ...
            'OAT_Temperature':        {'read': True, 'write': False, 'opcode': '1a5c', 'reply_token': '1a5c', 'item_type': 'num',  'dev_datatype': 'V', 'params': ['value', 'len'], 'param_values': ['VAL', 1]},     # getTempOAT -- OAT Temperature
            'ICT_Temperature':        {'read': True, 'write': False, 'opcode': '1a5d', 'reply_token': '1a5d', 'item_type': 'num',  'dev_datatype': 'V', 'params': ['value', 'len'], 'param_values': ['VAL', 1]},     # getTempICT -- OCT Temperature
            'CCT_Temperature':        {'read': True, 'write': False, 'opcode': '1a5e', 'reply_token': '1a5e', 'item_type': 'num',  'dev_datatype': 'V', 'params': ['value', 'len'], 'param_values': ['VAL', 1]},     # getTempCCT -- CCT Temperature
            'HST_Temperature':        {'read': True, 'write': False, 'opcode': '1a5f', 'reply_token': '1a5f', 'item_type': 'num',  'dev_datatype': 'V', 'params': ['value', 'len'], 'param_values': ['VAL', 1]},     # getTempHST -- HST Temperature
            'OMT_Temperature':        {'read': True, 'write': False, 'opcode': '1a60', 'reply_token': '1a60', 'item_type': 'num',  'dev_datatype': 'V', 'params': ['value', 'len'], 'param_values': ['VAL', 1]},     # getTempOMT -- OMT Temperature
