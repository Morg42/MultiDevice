...
commands = {
    'info': {
        ...
        'albumart':   {'read': True, 'write': False, 'opcode': '', 'reply_token': 'albumart_url', 'item_type': 'str', 'dev_datatype': 'url'},
        ...
        'zones':      {'read': True, 'write': False, 'opcode': '', 'reply_token': 'system.zone_num', 'item_type': 'num', 'dev_datatype': 'mc'},
        'inputs_raw': {'read': True, 'write': False, 'opcode': '', 'reply_token': 'input_list', 'item_type': 'list', 'dev_datatype': 'mc'},
        'inputs_sys': {'read': True, 'write': False, 'opcode': '', 'reply_token': '', 'item_type': 'list', 'dev_datatype': 'mc'},
        'inputs_user':{'read': True, 'write': False, 'opcode': '', 'reply_token': '', 'item_type': 'list', 'dev_datatype': 'mc'},
    ...
    'main': {
        ...
        'power':      {'read': True, 'write': True,  'opcode': ':v1/main/setPower?power={VAL}:', 'reply_token': 'main.power', 'item_type': 'bool', 'dev_datatype': 'mc', 'lookup': 'power', 'item_attrs': {'enforce': True}},
        'sleep':      {'read': True, 'write': True,  'opcode': ':v1/main/setSleep?sleep={VAL}:', 'reply_token': 'main.sleep', 'item_type': 'num', 'dev_datatype': 'mc', 'item_attrs': {'enforce': True}},
