...
commands = {
    'general': {
        ...
        'inputname_DVD': {'read': True, 'write': False, 'read_cmd': 'SSFUN ?', 'item_type': 'str', 'dev_datatype': 'str', 'reply_token': 'REGEX', 'reply_pattern': 'SSFUNDVD (.*)'},
        'inputname_BD': {'read': True, 'write': False, 'read_cmd': 'SSFUN ?', 'item_type': 'str', 'dev_datatype': 'str', 'reply_token': 'REGEX', 'reply_pattern': 'SSFUNBD (.*)'},
        'inputname_TV': {'read': True, 'write': False, 'read_cmd': 'SSFUN ?', 'item_type': 'str', 'dev_datatype': 'str', 'reply_token': 'REGEX', 'reply_pattern': 'SSFUNTV (.*)'},
        'inputname_SAT': {'read': True, 'write': False, 'read_cmd': 'SSFUN ?', 'item_type': 'str', 'dev_datatype': 'str', 'reply_token': 'REGEX', 'reply_pattern': 'SSFUNSAT/CBL (.*)'},
        'inputname_MPLAY': {'read': True, 'write': False, 'read_cmd': 'SSFUN ?', 'item_type': 'str', 'dev_datatype': 'str', 'reply_token': 'REGEX', 'reply_pattern': 'SSFUNMPLAY (.*)'},
        'inputname_GAME': {'read': True, 'write': False, 'read_cmd': 'SSFUN ?', 'item_type': 'str', 'dev_datatype': 'str', 'reply_token': 'REGEX', 'reply_pattern': 'SSFUNGAME (.*)'},
        'inputname_AUX1': {'read': True, 'write': False, 'read_cmd': 'SSFUN ?', 'item_type': 'str', 'dev_datatype': 'str', 'reply_token': 'REGEX', 'reply_pattern': 'SSFUNAUX1 (.*)'},
        'inputname_CD': {'read': True, 'write': False, 'read_cmd': 'SSFUN ?', 'item_type': 'str', 'dev_datatype': 'str', 'reply_token': 'REGEX', 'reply_pattern': 'SSFUNCD (.*)'},
        'inputname_AUX2': {'read': True, 'write': False, 'read_cmd': 'SSFUN ?', 'item_type': 'str', 'dev_datatype': 'str', 'reply_token': 'REGEX', 'reply_pattern': 'SSFUNAUX2 (.*)'},
        'inputname_PHONO': {'read': True, 'write': False, 'read_cmd': 'SSFUN ?', 'item_type': 'str', 'dev_datatype': 'str', 'reply_token': 'REGEX', 'reply_pattern': 'SSFUNPHONO (.*)'},
    ...
    'zone1': {
        ...
        'volume': {'read': True, 'write': True, 'read_cmd': 'MV?', 'write_cmd': 'MVMD_VALUE', 'item_type': 'num', 'dev_datatype': 'DenonVol', 'reply_token': 'REGEX', 'reply_pattern': r'MV(\d{2,3})', 'settings': {'force_min': 0.0, 'valid_max': 98.0} },
        ...
        'input': {'read': True, 'write': True, 'read_cmd': 'SI?', 'write_cmd': 'SIMD_VALUE', 'item_type': 'str', 'dev_datatype': 'str', 'reply_token': 'REGEX', 'reply_pattern': 'SI(.*)', 'lookup': 'INPUT'},
        'listeningmode': {'read': True, 'write': True, 'settings': {'valid_list_ci': ['MOVIE', 'MUSIC', 'GAME', 'DIRECT', 'PURE DIRECT', 'STEREO', 'AUTO', 'DOLBY DIGITAL', 'DTS SURROUND', 'AURO3D', 'AURO2DSURR', 'MCH STEREO', 'ROCK ARENA', 'JAZZ CLUB', 'MONO MOVIE', 'MATRIX', 'VIDEO GAME', 'VIRTUAL', 'LEFT', 'RIGHT']}, 'read_cmd': 'MS?', 'write_cmd': ':MS{VAL_UPPER}:', 'item_type': 'str', 'dev_datatype': 'str', 'reply_token': 'REGEX', 'reply_pattern': 'MS(MD_VALID_LIST_CI)'},
        'sleep': {'read': True, 'write': True, 'item_type': 'num', 'read_cmd': 'SLP?', 'write_cmd': 'SLPMD_VALUE', 'dev_datatype': 'convert0', 'reply_token': 'REGEX', 'reply_pattern': r'SLP(\d{3}|OFF)', 'settings': {'force_min': 0, 'force_max': 120} },
        'standby': {'read': True, 'write': True, 'item_type': 'num', 'read_cmd': 'STBY?', 'write_cmd': 'STBYMD_VALUE', 'dev_datatype': 'DenonStandby1', 'reply_token': 'REGEX', 'reply_pattern': r'STBY(\d{2}M|OFF)', 'settings': {'valid_list_ci': [0, 15, 30, 60]} },
        ...
        'speakersetup': {'opcode': 'MD_VALUE', 'read': True, 'write': True, 'settings': {'valid_list_ci': ['FL', 'HF']}, 'read_cmd': 'PSSP: ?', 'write_cmd': ':PSSP:{VAL_UPPER}:', 'item_type': 'str', 'dev_datatype': 'str', 'reply_token': 'REGEX', 'reply_pattern': 'PSSP:(FL|HF|FR)'},
        ...
        'hdmimonitor': {'read': True, 'write': True, 'settings': {'force_min': 0, 'force_max': 2}, 'read_cmd': 'VSMONI ?', 'write_cmd': 'VSMONIMD_VALUE', 'item_type': 'num', 'dev_datatype': 'convertAuto', 'reply_token': 'REGEX', 'reply_pattern': 'VSMONI(AUTO|1|2)'},
        ...
        'hdmiaudioout': {'read': True, 'write': True, 'item_type': 'str', 'read_cmd': 'VSAUDIO ?', 'write_cmd': ':VSAUDIO {VAL_UPPER}:', 'dev_datatype': 'str', 'reply_token': 'REGEX', 'reply_pattern': 'VSAUDIO (TV|AMP)', 'settings': {'valid_list_ci': ['TV', 'AMP']} },
        ...
        'dynamicrange': {'read': True, 'write': True, 'read_cmd': 'PSDRC ?', 'item_type': 'str', 'write_cmd': 'PSDRC MD_VALUE', 'dev_datatype': 'str', 'reply_token': 'REGEX', 'reply_pattern': 'PSDRC ([A-Z]{2,4})', 'lookup': 'DYNAM'},
        ...
        'dialog': {'read': True, 'write': True, 'read_cmd': 'PSDIL ?', 'item_type': 'num', 'settings': {'force_min': -12, 'force_max': 12}, 'write_cmd': 'PSDIL MD_VALUE', 'dev_datatype': 'remap50to0', 'reply_token': 'REGEX', 'reply_pattern': r'PSDIL (\d{2})'},
        ...
        'dialogenhance': {'read': True, 'write': True, 'read_cmd': 'PSDEH ?', 'write_cmd': 'PSDEH MD_VALUE', 'item_type': 'str', 'dev_datatype': 'str', 'reply_token': 'REGEX', 'reply_pattern': 'PSDEH ([A-Z]{3,4})', 'lookup': 'DIALOG'},
        'pictureenhancer': {'read': True, 'write': True, 'read_cmd': 'PVENH ?', 'item_type': 'num', 'settings': {'force_min': 0, 'force_max': 12}, 'write_cmd': ':PVENH {VAL:02}:', 'dev_datatype': 'int', 'reply_token': 'REGEX', 'reply_pattern': r'PVENH (\d{2})'},
        ...
        'subwoofer': {'read': True, 'write': True, 'read_cmd': 'PSSWL ?', 'item_type': 'num', 'settings': {'force_min': -12, 'valid_max': 12}, 'write_cmd': 'PSSWL MD_VALUE', 'dev_datatype': 'remap50to0', 'reply_token': 'REGEX', 'reply_pattern': r'PSSWL (\d{2})'},
        ...
        'lfe': {'read': True, 'write': True, 'read_cmd': 'PSLFE ?', 'item_type': 'num', 'settings': {'force_min': -10, 'valid_max': 3}, 'write_cmd': ':PSLFE {VAL:02}:', 'dev_datatype': 'int', 'reply_token': 'REGEX', 'reply_pattern': r'PSLFE (\d{2})'},
        ...
        'audioinput': {'read': True, 'write': True, 'settings': {'valid_list_ci': ['AUTO', 'HDMI', 'DIGITAL', 'ANALOG']}, 'read_cmd': 'SD?', 'write_cmd': ':SD{VAL_UPPER}:', 'item_type': 'str', 'dev_datatype': 'str', 'reply_token': 'REGEX', 'reply_pattern': 'SD(.*)'},
        'videoinput': {'read': True, 'write': True, 'settings': {'valid_list_ci': ['DVD', 'BD', 'TV', 'SAT/CBL', 'MPLAY', 'GAME' 'AUX1', 'AUX2', 'CD', 'ON', 'OFF']}, 'read_cmd': 'SV?', 'write_cmd': ':SV{VAL_UPPER}:', 'item_type': 'str', 'dev_datatype': 'str', 'reply_token': 'REGEX', 'reply_pattern': 'SV(.*)'},
        'ecomode': {'opcode': 'MD_VALUE', 'read': True, 'write': True, 'settings': {'valid_list_ci': ['ON', 'OFF', 'AUTO']}, 'read_cmd': 'ECO?', 'write_cmd': ':ECO{VAL_UPPER}:', 'item_type': 'str', 'dev_datatype': 'str', 'reply_token': 'REGEX', 'reply_pattern': 'ECO(ON|OFF|AUTO)'},
        'treble': {'read': True, 'write': True, 'read_cmd': 'PSTRE ?', 'item_type': 'num', 'settings': {'force_min': -6, 'force_max': 6}, 'write_cmd': 'PSTRE MD_VALUE', 'dev_datatype': 'remap50to0', 'reply_token': 'REGEX', 'reply_pattern': r'PSTRE (\d{2})'},
        ...
        'bass': {'read': True, 'write': True, 'read_cmd': 'PSBAS ?', 'item_type': 'num', 'settings': {'force_min': -6, 'force_max': 6}, 'write_cmd': 'PSBAS MD_VALUE', 'dev_datatype': 'remap50to0', 'reply_token': 'REGEX', 'reply_pattern': r'PSBAS (\d{2})'},
        ...
        'levels': {
            'front_left': {'read': True, 'write': True, 'settings': {'force_min': -12.0, 'valid_max': 12.0}, 'read_cmd': 'CV?', 'item_type': 'num', 'write_cmd': 'CVFL MD_VALUE', 'dev_datatype': 'remap50to0', 'reply_token': 'REGEX', 'reply_pattern': r'CVFL (\d{2,3})'},
            'front_right': {'read': True, 'write': True, 'settings': {'force_min': -12.0, 'valid_max': 12.0}, 'read_cmd': 'CV?', 'item_type': 'num', 'write_cmd': 'CVFR MD_VALUE', 'dev_datatype': 'remap50to0', 'reply_token': 'REGEX', 'reply_pattern': r'CVFR (\d{2,3})'},
            'front_height_left': {'read': True, 'write': True, 'settings': {'force_min': -12.0, 'valid_max': 12.0}, 'read_cmd': 'CV?', 'item_type': 'num', 'write_cmd': 'CVFHL MD_VALUE', 'dev_datatype': 'remap50to0', 'reply_token': 'REGEX', 'reply_pattern': r'CVFHL (\d{2,3})'},
            'front_height_right': {'read': True, 'write': True, 'settings': {'force_min': -12.0, 'valid_max': 12.0}, 'read_cmd': 'CV?', 'item_type': 'num', 'write_cmd': 'CVFHR MD_VALUE', 'dev_datatype': 'remap50to0', 'reply_token': 'REGEX', 'reply_pattern': r'CVFHR (\d{2,3})'},
            'front_center': {'read': True, 'write': True, 'settings': {'force_min': -12.0, 'valid_max': 12.0}, 'read_cmd': 'CV?', 'item_type': 'num', 'write_cmd': 'CVC MD_VALUE', 'dev_datatype': 'remap50to0', 'reply_token': 'REGEX', 'reply_pattern': r'CVC (\d{2,3})'},
            'surround_left': {'read': True, 'write': True, 'settings': {'force_min': -12.0, 'valid_max': 12.0}, 'read_cmd': 'CV?', 'item_type': 'num', 'write_cmd': 'CVSL MD_VALUE', 'dev_datatype': 'remap50to0', 'reply_token': 'REGEX', 'reply_pattern': r'CVSL (\d{2,3})'},
            'surround_right': {'read': True, 'write': True, 'settings': {'force_min': -12.0, 'valid_max': 12.0}, 'read_cmd': 'CV?', 'item_type': 'num', 'write_cmd': 'CVSR MD_VALUE', 'dev_datatype': 'remap50to0', 'reply_token': 'REGEX', 'reply_pattern': r'CVSR (\d{2,3})'},
            'surroundback_left': {'read': True, 'write': True, 'settings': {'force_min': -12.0, 'valid_max': 12.0}, 'read_cmd': 'CV?', 'item_type': 'num', 'write_cmd': 'CVSBL MD_VALUE', 'dev_datatype': 'remap50to0', 'reply_token': 'REGEX', 'reply_pattern': r'CVSBL (\d{2,3})'},
            'surroundback_right': {'read': True, 'write': True, 'settings': {'force_min': -12.0, 'valid_max': 12.0}, 'read_cmd': 'CV?', 'item_type': 'num', 'write_cmd': 'CVSBR MD_VALUE', 'dev_datatype': 'remap50to0', 'reply_token': 'REGEX', 'reply_pattern': r'CVSBR (\d{2,3})'},
            'rear_height_left': {'read': True, 'write': True, 'settings': {'force_min': -12.0, 'valid_max': 12.0}, 'read_cmd': 'CV?', 'item_type': 'num', 'write_cmd': 'CVRHL MD_VALUE', 'dev_datatype': 'remap50to0', 'reply_token': 'REGEX', 'reply_pattern': r'CVRHL (\d{2,3})'},
            'rear_height_right': {'read': True, 'write': True, 'settings': {'force_min': -12.0, 'valid_max': 12.0}, 'read_cmd': 'CV?', 'item_type': 'num', 'write_cmd': 'CVRHR MD_VALUE', 'dev_datatype': 'remap50to0', 'reply_token': 'REGEX', 'reply_pattern': r'CVRHR (\d{2,3})'},
            'subwoofer': {'read': True, 'write': True, 'settings': {'force_min': -12.0, 'valid_max': 12.0}, 'read_cmd': 'CV?', 'item_type': 'num', 'write_cmd': 'CVSW MD_VALUE', 'dev_datatype': 'remap50to0', 'reply_token': 'REGEX', 'reply_pattern': r'CVSW (\d{2,3})'},
            'subwoofer2': {'read': True, 'write': True, 'settings': {'force_min': -12.0, 'valid_max': 12.0}, 'read_cmd': 'CV?', 'item_type': 'num', 'write_cmd': 'CVSW2 MD_VALUE', 'dev_datatype': 'remap50to0', 'reply_token': 'REGEX', 'reply_pattern': r'CVSW2 (\d{2,3})'},
        }
    },
    'zone2': {
        ...
        'volume': {'read': True, 'write': True, 'read_cmd': 'Z2?', 'write_cmd': 'Z2MD_VALUE', 'item_type': 'num', 'dev_datatype': 'DenonVol', 'reply_token': 'REGEX', 'reply_pattern': r'Z2(\d{2,3})', 'settings': {'force_min': 0.0, 'valid_max': 98.0} },
        ...
        'bass': {'read': True, 'write': True, 'read_cmd': 'Z2PSBAS ?', 'item_type': 'num', 'settings': {'force_min': -10, 'force_max': 10}, 'write_cmd': 'Z2PSBAS MD_VALUE', 'dev_datatype': 'remap50to0', 'reply_token': 'REGEX', 'reply_pattern': r'Z2PSBAS (\d{2})'},
    ...
    'zone3': {
        ...
        'bass': {'read': True, 'write': True, 'read_cmd': 'Z3PSBAS ?', 'item_type': 'num', 'settings': {'force_min': -10, 'force_max': 10}, 'write_cmd': 'Z3PSBAS MD_VALUE', 'dev_datatype': 'remap50to0', 'reply_token': 'REGEX', 'reply_pattern': r'Z3PSBAS (\d{2})'},
