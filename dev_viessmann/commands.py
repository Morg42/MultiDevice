...
commands = {
    '_': {
        'V200KO1B': {
            ...
            'Anlagentyp':                               {'read': True,  'write': False, 'opcode': '00f8', 'reply_token': '00f8', 'item_type': 'int',  'dev_datatype': 'V', 'params': ['value', 'len'], 'param_values': ['VAL', 2], 'lookup': 'devicetypes'},     # Heizungstyp
        ...
        'V200KW2':                                              {
            # Allgemein
            'Anlagentyp':                               {'read': True,  'write': False, 'opcode': '00f8', 'reply_token': '00f8', 'item_type': 'int',  'dev_datatype': 'V', 'params': ['value', 'len'], 'param_values': ['VAL', 2], 'lookup': 'devicetypes'},     # Ermittle Device Typ der Anlage
            'Anlagenschema':                            {'read': True,  'write': False, 'opcode': '7700', 'reply_token': '7700', 'item_type': 'int',  'dev_datatype': 'V', 'params': ['value', 'len'], 'param_values': ['VAL', 2], 'lookup': 'systemschemes'},     # Anlagenschema
