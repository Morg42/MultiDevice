...
commands = {
    ...
    'main': {
        ...
        'power':      {'read': True,  'write': True,  'opcode': ':v1/main/setPower?power={VAL}:', 'reply_pattern': 'main.power', 'item_type': 'bool', 'dev_datatype': 'mc', 'lookup': 'power', 'item_attrs': {'enforce': True}},
        'sleep':      {'read': True,  'write': True,  'opcode': ':v1/main/setSleep?sleep={VAL}:', 'reply_pattern': 'main.sleep', 'item_type': 'num', 'dev_datatype': 'mc', 'item_attrs': {'enforce': True}},
    ...
    'netusb': {
        ...
        'playback':   {'read': True,  'write': True,  'opcode': ':v1/netusb/setPlayback?playback={VAL}:', 'reply_pattern': 'playback', 'item_type': 'str', 'dev_datatype': 'mc', 'cmd_settings': {'valid_list': ['play', 'stop', 'pause', 'play_pause', 'previous', 'next', 'fast_reverse_start', 'fast_reverse_stop', 'fast_forward_start', 'fast_forward_stop']}, 'item_attrs': {'enforce': True}},
