...
commands = {
    ...
    'system': {
        'passthru':   {'read': True,  'write': True,  'opcode': '{RAW_VALUE}', 'item_type': 'str', 'dev_datatype': 'mc', 'item_attrs': {'enforce': True}},
    ...
    'main': {
        ...
        'power':      {'read': True,  'write': True,  'opcode': 'v1/main/setPower?power={RAW_VALUE}', 'reply_pattern': 'main.power', 'item_type': 'bool', 'dev_datatype': 'mc', 'lookup': 'power', 'item_attrs': {'enforce': True}},
        'sleep':      {'read': True,  'write': True,  'opcode': 'v1/main/setSleep?sleep={RAW_VALUE}', 'reply_pattern': 'main.sleep', 'item_type': 'num', 'dev_datatype': 'mc', 'item_attrs': {'enforce': True}},
        'input':      {'read': True,  'write': True,  'opcode': 'v1/main/setInput?input={RAW_VALUE}', 'reply_pattern': 'input', 'item_type': 'str', 'dev_datatype': 'mc', 'item_attrs': {'enforce': True}},
        'mute':       {'read': True,  'write': True,  'opcode': 'v1/main/setMute?enable={RAW_VALUE}', 'reply_pattern': 'mute', 'item_type': 'bool', 'dev_datatype': 'mc', 'lookup': 'bool', 'item_attrs': {'enforce': True}},
        'volume':     {'read': True,  'write': True,  'opcode': 'v1/main/setVolume?volume={RAW_VALUE}', 'reply_pattern': 'volume', 'item_type': 'num', 'dev_datatype': 'mc', 'item_attrs': {'enforce': True}},
    ...
    'netusb': {
        ...
        'preset':     {'read': True,  'write': True,  'opcode': 'v1/netusb/recallPreset?zone=main&num={RAW_VALUE}', 'item_type': 'num', 'dev_datatype': 'mc', 'item_attrs': {'enforce': True}},
        'playback':   {'read': True,  'write': True,  'opcode': 'v1/netusb/setPlayback?playback={RAW_VALUE}', 'reply_pattern': 'playback', 'item_type': 'str', 'dev_datatype': 'mc', 'cmd_settings': {'valid_list': ['play', 'stop', 'pause', 'play_pause', 'previous', 'next', 'fast_reverse_start', 'fast_reverse_stop', 'fast_forward_start', 'fast_forward_stop']}, 'item_attrs': {'enforce': True}},
        'position':   {'read': True,  'write': True,  'opcode': 'v1/netusb/setPlayPosition?position={RAW_VALUE}', 'item_type': 'num', 'dev_datatype': 'mc', 'item_attrs': {'enforce': True}},
    },
    'alarm': {
        'enable':     {'read': True,  'write': True,  'opcode': 'v1/clock/setAlarmSettings', 'reply_pattern': '', 'item_type': 'bool', 'dev_datatype': 'al_on', 'lookup': 'bool', 'item_attrs': {'enforce': True}},
        'time':       {'read': True,  'write': True,  'opcode': 'v1/clock/setAlarmSettings', 'reply_pattern': '', 'item_type': 'str', 'dev_datatype': 'al_time', 'item_attrs': {'enforce': True}},
        'beep':       {'read': True,  'write': True,  'opcode': 'v1/clock/setAlarmSettings', 'reply_pattern': '', 'item_type': 'bool', 'dev_datatype': 'al_beep', 'lookup': 'bool', 'item_attrs': {'enforce': True}},
    }
}
